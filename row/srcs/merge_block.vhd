    ...
    component FIFO_FWFT is
        ...
        Port (
         ...
         -- what is the size of array?
            size: out std_logic_vector(DEPTH-1 DOWNTO 0);
...
if reset='1' then
    ...
    if rd_en_right_int='1' or rd_en_left_int='1' then
        ...
        rd_en_left_int<='0';
        rd_en_right_int<='0';
    elsif empty_in_left='0' and empty_in_right='0' and i_valid='1' then
        wr_en<='1';
    ...
    elsif empty_in_left='1' and empty_in_right='0' and i_valid='1' then
        wr_en<='1';
        d_in<=d_in_right;
        rd_en_right_int<='1';
        rd_en_left_int<='0';
    elsif empty_in_left='0' and empty_in_right='1' and i_valid='1' then
        wr_en<='1';
        d_in<=d_in_left;
        rd_en_left_int<='1';
        rd_en_right_int<='0';
